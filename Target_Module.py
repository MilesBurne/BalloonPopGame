...
class Target():
    ...
    def __init__(self, surface, pos, speed=0.2, variance=0.2, size=(60,150), crate=False):
        #value specifies whether a crate or not
        self.crate = crate
        ...
        self.image = self.pygame.transform.smoothscale(self.image,(size))
        ...
        self.minimum_size = (size[0]*0.1,size[1]*0.1)
        ...
        #variable to control whether the balloon is on screen or not
        self.on_screen = True
    ...
    def collide(self):
        ...
        elif random_difficult == 2 and self.size[0] > self.minimum_size[0]:#changes size if size is greater than a minimum
